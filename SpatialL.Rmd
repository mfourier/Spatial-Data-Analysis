...
Para hacer uso de la data que nos proporciona el paquete tidycensus debemos hacer uso de una $\textit{key}$ que nos permita el acceso a la información.
...
## Anexo 2: Uso de librerías ggplot2 y tmap para plots con referencias geográficas
...
## Anexo 3: Discusión sobre el índice de Moran
